...
#define ast_sip_push_task_internal(serializer, sip_task, task_data) \
	ast_sip_push_task_origin(serializer, sip_task, task_data, __FILE__, __LINE__, __PRETTY_FUNCTION__)
int ast_sip_push_task(struct ast_taskprocessor *serializer, int (*sip_task)(void *), void *task_data);

int ast_sip_push_task_origin(struct ast_taskprocessor *serializer, int (*sip_task)(void *), void *task_data,
	const char *file, int line, const char *function)
{
	...
	return ast_taskprocessor_push_origin(serializer, sip_task, task_data, file, line, function);
}

/* ABI compatibility: Provide actual function symbol for external modules */
int ast_sip_push_task(struct ast_taskprocessor *serializer, int (*sip_task)(void *), void *task_data)
{
	return ast_sip_push_task_origin(serializer, sip_task, task_data, NULL, 0, NULL);
}
...
int ast_sip_push_task_wait_servant(struct ast_taskprocessor *serializer, int (*sip_task)(void *), void *task_data)
{
	return ast_sip_push_task_wait_servant_origin(serializer, sip_task, task_data, NULL, 0, NULL);
}
...
int ast_sip_push_task_synchronous(struct ast_taskprocessor *serializer, int (*sip_task)(void *), void *task_data)
{
	return ast_sip_push_task_synchronous_origin(serializer, sip_task, task_data, NULL, 0, NULL);
}
...
int ast_sip_push_task_wait_serializer(struct ast_taskprocessor *serializer, int (*sip_task)(void *), void *task_data)
{
	return ast_sip_push_task_wait_serializer_origin(serializer, sip_task, task_data, NULL, 0, NULL);
}
...
static int ast_sip_push_task_wait_origin(struct ast_taskprocessor *serializer, int (*sip_task)(void *), void *task_data,
	const char *file, int line, const char *function)
{
	...
	if (ast_sip_push_task_origin(serializer, sync_task, &std, file, line, function)) {
...
int ast_sip_push_task_wait_servant_origin(struct ast_taskprocessor *serializer, int (*sip_task)(void *), void *task_data,
	const char *file, int line, const char *function)
{
	...
	return ast_sip_push_task_wait_origin(serializer, sip_task, task_data, file, line, function);
}

int ast_sip_push_task_synchronous_origin(struct ast_taskprocessor *serializer, int (*sip_task)(void *), void *task_data,
	const char *file, int line, const char *function)
{
	return ast_sip_push_task_wait_servant_origin(serializer, sip_task, task_data, file, line, function);
}

int ast_sip_push_task_wait_serializer_origin(struct ast_taskprocessor *serializer, int (*sip_task)(void *), void *task_data,
	const char *file, int line, const char *function)
{
	if (!serializer) {
