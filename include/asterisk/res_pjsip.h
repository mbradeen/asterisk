...
#define ast_sip_push_task_wait_servant(serializer, sip_task, task_data) \
	ast_sip_push_task_wait_servant_origin(serializer, sip_task, task_data, __FILE__, __LINE__, __PRETTY_FUNCTION__)
...
#define ast_sip_push_task_synchronous(serializer, sip_task, task_data) \
	ast_sip_push_task_synchronous_origin(serializer, sip_task, task_data, __FILE__, __LINE__, __PRETTY_FUNCTION__)
...
#define ast_sip_push_task_wait_serializer(serializer, sip_task, task_data) \
	ast_sip_push_task_wait_serializer_origin(serializer, sip_task, task_data, __FILE__, __LINE__, __PRETTY_FUNCTION__)
